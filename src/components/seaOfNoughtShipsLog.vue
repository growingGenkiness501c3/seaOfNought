...
U+329x	㊐</div>
  ...
  <div class="border border-sky-400 cursor-pointer hover:opacity-30 text-center" >
    🗃️<br>gg<br>growingGenkiness</div>
...
<strong>Navigational data </strong>(position, speed, heading) ;<strong> Weather conditions  </strong>;<strong> ⛵ events </strong>(e.g., changes in crew, incidents, maintenance) ; <strong> Port entries/departures  </strong>;<strong> Communications</strong>
The term "㏒" comes from the historical use of a ㏒ line (a rope with knots used to measure a ship’s speed), and recording that data gave rise to the term ㏒🕮.
</div>
</template>
